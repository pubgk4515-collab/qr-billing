...
export default function PremiumStoreAnalytics({ params }: { params: Promise<{ store_slug: string }> }) {
  ...
  // 🔥 DYNAMIC HIGH NUMBER METRIC: Calculating exact revenue generated by only the top sellers
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans pb-24 selection:bg-white/10">
      ...
      <main className="max-w-md mx-auto px-5 py-6 flex flex-col gap-5">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="relative bg-[#0a0a0a] border border-white/5 rounded-[2rem] overflow-hidden shadow-2xl mt-2">
          ...
          <div className={`p-6 flex flex-col gap-3 ${!isPremiumUser ? 'filter blur-[8px] opacity-30 select-none pointer-events-none' : ''}`}>
        ...
        {/* 🏆 5. VELOCITY MATRIX (Now with Massive Top Metric & Blur) */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="relative bg-[#0a0a0a] border border-white/5 rounded-[2rem] overflow-hidden shadow-2xl mt-2">
          ...
          <div className="p-6 pb-4 border-b border-white/5 relative z-20 bg-[#0a0a0a]">
            ...
            {/* 🔥 MASSIVE TOP METRIC (Stays Unblurred) */}
            <div>
          ...
          {/* THE BLURRED GRID */}
          <div className={`p-6 grid grid-cols-2 gap-3 ${!isPremiumUser ? 'filter blur-[8px] opacity-30 select-none pointer-events-none' : ''}`}>
          ...
          {/* THE CLEAN OVERLAY */}
          {!isPremiumUser && (
            <div className="absolute inset-0 top-[140px] z-30 flex flex-col items-center justify-center bg-black/50 backdrop-blur-[1px] p-6">
              <div className="w-12 h-12 bg-[#111] rounded-full border border-white/10 flex items-center justify-center mb-4 shadow-xl">
                <Lock className="w-5 h-5 text-zinc-300" />
              </div>
        ...
        {/* 📐 6. DEMAND GEOMETRY */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="bg-[#0a0a0a] border border-white/5 rounded-[2rem] p-6 relative overflow-hidden mt-2">
