...
export default function HomeButton() {
  ...
  return createPortal(
    <button
      ...
      className="fixed bottom-10 right-6 sm:bottom-12 sm:right-8 bg-zinc-900 border border-emerald-500/50 p-4 rounded-full shadow-[0_0_20px_rgba(16,185,129,0.5)] hover:bg-zinc-800 transition-all active:scale-95 group"
    >
